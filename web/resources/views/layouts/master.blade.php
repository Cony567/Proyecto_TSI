              ...
              <div class="flex collapse navbar-collapse" id="navbarTogglerDemo03">
                ...
                <div class="dropdown ms-3">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="bd-versions">
                        ...
                        @else
                        <li><a class="dropdown-item current" aria-current="true" href="{{route('crear_perfil')}}">Inicie Seción o Regístrese</a></li>
                        @endauth
                ...
                <div class="dropdown ms-3">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="bd-versions">
                      ...
                      <li><hr class="dropdown-divider"></li>
                      @guest
                        <li><a class="dropdown-item" href="#">Inicio Sesión/Registro</a></li>
                      @endguest
                      
                      @auth
                        <li><hr class="dropdown-divider"></li>
                        <li><a class="dropdown-item" href="/docs/versions/">Cerrar Sesión</a></li>
