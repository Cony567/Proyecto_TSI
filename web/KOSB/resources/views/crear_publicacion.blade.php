  ...
  <div class="col-12 col-md-6 col-lg-4">
    <div class="card mt-2">
      ...
      <!-- Barritas a cargar de la base de datos  -->
        ...
        <div class="mb-3">
          <label for="total-pedido" class="form-label">Duración	del trabajo (Tiempo en hrs)</label>
          <input  type="number" class="form-control input-time-b" id="total-pedido">
        </div>
    <!-- Agregar plugin de calendario  -->

        <div class="mb-3" id="f">
            <label for="total-pedido" class="form-label">Fecha Del Trabajo</label>
            <input  type="text" class="form-control flatpickr flatpickr-input" readonly="readonly" id="fecha-trabajo" >
        </div>
    ...
    <div class="card shadow-lg mt-2">
      <div class="card-body" style="height: 500px">
        <div class="contenedor" style="max-height: 460px; width: auto;">
          <div class="mt-2">
            <h3 class="text-start ms-3"><u>Título de la publicación</u></h3>
          </div>
          
          <p class="text-end pe-5">tipo de empleo!</p>
          <section class="ps-3 pe-5">
            <p class="h6"><strong>Descripción</strong></p>
            <div class="contenedor" style="border: solid #cecece .1px;border-radius: 2px; max-height: 200px; width: auto;">
              <p class="text-start ps-2">Aquí irá la descripción de su publicación</p>
            </div>
          </section>
      ...
      <div class="card-footer text-end">
        <button class="btn text-ligth" disabled id="guardar-btn" style="background-color: #FF6F61; color:#fff">Finalizar y Guardar creación</button>
      </div>
    </div>
...
<script src="{{asset('javascript/crear_publicacion.js')}}"></script>
<script src="{{asset('javascript/flatpicker.js')}}"></script>
